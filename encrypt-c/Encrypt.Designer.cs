...
namespace encrypt_c {
    ...
    public sealed partial class Encrypt : Microsoft.Office.Tools.Outlook.OutlookAddInBase {
        ...
        public Encrypt(global::Microsoft.Office.Tools.Outlook.Factory factory, global::System.IServiceProvider serviceProvider) : 
    ...
    internal sealed partial class Globals {
        ...
        internal static Encrypt Encrypt {
            get {
                return _Encrypt;
            }
            set {
        ...
        internal static ThisFormRegionCollection FormRegions {
            get {
                if ((_ThisFormRegionCollection == null)) {
                    _ThisFormRegionCollection = new ThisFormRegionCollection(Globals.Encrypt.GetFormRegions());
                }
    ...
    internal sealed partial class ThisFormRegionCollection : Microsoft.Office.Tools.Outlook.FormRegionCollectionBase {
        ...
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Explorer explorer] {
            get {
                return ((WindowFormRegionCollection)(Globals.Encrypt.GetFormRegions(explorer, typeof(WindowFormRegionCollection))));
            }
        }
        
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Inspector inspector] {
            get {
                return ((WindowFormRegionCollection)(Globals.Encrypt.GetFormRegions(inspector, typeof(WindowFormRegionCollection))));
            }
        }
    }
